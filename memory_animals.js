...
var callSRC = ["A BEAR", "A BIRD", "A BUTTERFLY", "A CAT", "A CHICKEN", "A COW", "A DOG", "A DOLPHIN",
    ...
    "A FLY", "A FROG", "A GORILLA", "A HEN", "A HIPPOPOTAMUS", "A KANGAROO", "A PANDA", "A PARROT", "A RAT", "A SHARK",
    "A SHEEP", "A SPIDER", "A SWAN", "A WOLF", "A ZEBRA", "AN ANT", "A JELLYFISH", "A CATERPILLAR"];
var call = [];
var response = [];
var Sounds = { names: [] };
...
$(document).ready(function () {
    $("#version").html("Memory - Animals v" + VERSION + " &copy 2014 C00lSch00l");
